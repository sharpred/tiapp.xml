...
describe('Tiapp', function () {
    ...
    describe('#Tiapp ios entitlements', function () {
        ...
        it('entitlements should be readable', function () {
            ...
            should.deepEqual(assocDomainEntitlement, ["applinks:app.piota.co.uk"]);
            ...
            should.deepEqual(assocDomainEntitlementTwo, ["applinks:app.piota.co.uk", "applinks:school.piota.co.uk"]);
        });
        ...
        it('an array of entitlement strings can be created with factory method', function () {
            ...
            var entitlementText = 'com.apple.developer.associated-domains-test3';
            tiapp.createIosEntitlement(entitlementText, ["applinks:faith.piota.co.uk", "applinks:school.piota.co.uk"]);
            var entitlement = tiapp.getIosEntitlement(entitlementText);
            should.exist(entitlement);
            should.deepEqual(entitlement, ["applinks:faith.piota.co.uk", "applinks:school.piota.co.uk"]);
            tiapp.write(tmpFile);
        });
