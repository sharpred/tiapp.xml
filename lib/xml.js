...
exports.getFirstElement = function getFirstElement(node, name) {
    var nodes = node.getElementsByTagName(name);
...
exports.ensureFirstElement = function ensureElement(node, name) {
    var elem = exports.getFirstElement(node, name);
    if (!elem) {
